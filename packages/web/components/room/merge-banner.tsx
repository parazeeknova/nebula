...
export const MergeBanner = ({ roomName }: { roomName: string }) => (
  <div className="border-blurple/25 from-blurple/15 shrink-0 border-b bg-gradient-to-r via-[#8b5cf6]/10 to-transparent px-4 py-2">
    <div className="flex items-center gap-3">
      ...
      <p className="text-ink min-w-0 flex-1 truncate text-[13px]">
        <span className="font-bold text-white">Neb is merging 2 angles</span>
        <span className="text-ink-dim">
          {" "}
          in {roomName} — both streams live below, synthesis lands as one pinned
          answer.
        </span>
      </p>
