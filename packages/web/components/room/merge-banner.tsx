    ...
    <div className="border-blurple/25 from-blurple/15 shrink-0 border-b bg-gradient-to-r via-[#8b5cf6]/10 to-transparent px-4 py-2">
      <div className="flex items-center gap-3">
        <span className="relative flex h-2.5 w-2.5 shrink-0">
          ...
          <span className="bg-blurple relative inline-flex h-2.5 w-2.5" />
        </span>
        ...
        <span className="bg-blurple hidden shrink-0 px-2.5 py-1 text-[11px] font-bold text-white shadow-[0_4px_14px_rgba(88,101,242,0.5)] sm:block">
          LIVE
        </span>
      </div>
    </div>
